...
describe('transaction', () => {
    ...
    it('testing Transaction.verify() method', async () => {
        const testTx = new Transaction();
        const bulkTxB58 = '';
        await testTx.fromBase58(bulkTxB58);

        await expect(testTx.verify()).rejects.toBeDefined();

        await expect((testTx as BulkTransaction).data.root.verify())
            .rejects.toEqual(new Error(Errors.BULK_ROOT_TX_NO_VERIFY));

        await expect((testTx as BulkTransaction).data.nodes[0].verify())
            .resolves.toBeTruthy();
    });
});
